...
/// Kept in sync with `trustsc::DEFAULT_STANDARD_DIGITS_GLYPH_SET_ID`.
...
/// `trustsc::STANDARD_ASCII_TEXT_GLYPH_SET_ID` (ADR-015).
...
impl CompileOptions {
    /// Generated code qualifies every type against `::trustsc` by default, so the including file
    /// needs no `use` statements (see `trustsc::include_medui_screen!`). Call `with_crate_path` to
...
"#;
    ...
    fn emits_generated_package_for_minimal_vertical_screen() {
        ...
        assert!(generated.contains(
            "cv_checks: &[::trustsc::CvCheckKind::Bounds, ::trustsc::CvCheckKind::ColorHash]"
        ));
        assert!(generated.contains("pub fn screen() -> &'static ::trustsc::CompiledScreenPackage"));
    ...
    fn compiles_a_signal_trace_node_with_stream_source_and_color() {
        ...
        assert!(generated.contains(
            "::trustsc::CompiledNodeKind::SignalTrace(::trustsc::SignalTraceSpec { stream_source: \"HELLO_WORLD_ECG\", color_token: \"Theme.Colors.Nominal\" })"
        ));
    }
...
"#;
    ...
    fn compiles_monitor_screen_with_row_to_flat_absolute_bounds() {
        ...
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 16, y: 16, width: 340, height: 48 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 372, y: 16, width: 676, height: 48 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 1064, y: 16, width: 200, height: 48 }"));
        // Vertical flow after the row: numeric display then viewport filling the rest.
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 16, y: 72, width: 1248, height: 120 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 16, y: 200, width: 1248, height: 504 }"));
        // Kinds emitted fully qualified.
        assert!(generated.contains("::trustsc::CompiledNodeKind::Label(::trustsc::LabelSpec"));
        assert!(generated.contains("::trustsc::ClockFormat::DateTimeSeconds"));
        assert!(generated.contains(
    ...
    fn row_spacing_of_zero_is_legal() {
        ...
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 16, y: 16, width: 340, height: 48 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 356, y: 16, width: 708, height: 48 }"));
    }
...
"#;
    ...
    fn compiles_positioned_screen_with_exact_declared_rects() {
        ...
        assert!(generated.contains(
            r#"::trustsc::CompiledNodeKind::Panel(::trustsc::PanelSpec { color_token: "Theme.Colors.TopbarBackground" })"#
        ));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 0, y: 0, width: 1280, height: 48 }"));
        // Positioned nodes land at EXACTLY their declared coordinates.
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 16, y: 0, width: 340, height: 48 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 372, y: 0, width: 448, height: 48 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 752, y: 56, width: 512, height: 512 }"));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 0, y: 56, width: 736, height: 656 }"));
    }
    ...
    fn positioned_nodes_get_automatic_bounds_golden_references() {
        ...
        assert_eq!(generated.matches("::trustsc::GoldenReferenceEntry {").count(), 4);
    ...
    fn compiles_an_image_at_its_intrinsic_size_with_an_automatic_bounds_golden() {
        ...
        assert!(generated.contains(
            r#"::trustsc::CompiledNodeKind::Image(::trustsc::ImageSpec { image_id: "LOGO-TEST" })"#
        ));
        assert!(generated.contains("bounds: ::trustsc::Rect { x: 752, y: 56, width: 144, height: 48 }"));
...
"#;
    ...
    fn emits_button_and_text_input_kinds_with_golden_references() {
        ...
        assert!(generated.contains(
            r#"::trustsc::CompiledNodeKind::Button(::trustsc::ButtonSpec { text_key: "STR-ACK", color_token: "Theme.Colors.PrimaryAction", source: "ACK_BUTTON", requirement_id: Some("REQ-NS-004") })"#
        ));
        assert!(generated.contains(
            r#"::trustsc::CompiledNodeKind::TextInput(::trustsc::TextInputSpec { source: "PATIENT_ID", max_length: 16, glyph_set_id: "SET-ASCII-TEXT", color_token: "Theme.Colors.Title", requirement_id: None })"#
        ));
        ...
        assert!(generated.contains(
            "bounds: ::trustsc::Rect { x: 16, y: 200, width: 512, height: 48 }"
        ));
    ...
    fn interactive_text_package() -> TextPackage {
        ...
        TextPackage {
            ...
            numeric_glyph_sets: vec![NumericGlyphSet {
                ...
                entries: vec![
                    trustsc_text_schema::NumericGlyphEntry {
                        character: 'A',
                        glyph_id: 50,
                        atlas_index: 0,
                        advance_x: 8,
    ...
    fn monitor_text_package() -> TextPackage {
        ...
        for (offset, character) in "0123456789-:".chars().enumerate() {
            entries.push(trustsc_text_schema::NumericGlyphEntry {
                character,
    ...
    fn display_text_package() -> TextPackage {
        ...
        TextPackage {
            ...
            numeric_templates: vec![trustsc_text_schema::NumericTemplate {
