//! The scenario plane (ADR-016 §4): authored TOML behavior scripts, compiled by `trustsc-build`
...
/// `adapters/trustsc-vulkan-winit`'s `RedrawRequested` handler): the input closure drains
