...
pub use trustsc_image_schema::{ImageEvidence, ImagePackage};
pub use trustsc_ml_authoring::{
...
pub use trustsc_ml_runtime::{Classifier1D, Prediction as MlPrediction};
pub use trustsc_ml_schema::{
...
/// Brings the module generated by [`trustsc-build`](https://docs.rs/trustsc-build)'s `MeduiScreen`
...
/// `trustsc_build::MeduiScreen::new(..).surface(..).compile()`.
#[macro_export]
macro_rules! include_medui_screen {
    () => {
        pub mod medui_screen {
            include!(concat!(env!("OUT_DIR"), "/trustsc_medui_screen.rs"));
        }
    };
}

/// Brings the module generated by [`trustsc-build`](https://docs.rs/trustsc-build)'s `ScenarioSet`
...
/// `trustsc_build::ScenarioSet::new(..).compile()`.
#[macro_export]
macro_rules! include_scenarios {
    () => {
        pub mod verify_scenarios {
            include!(concat!(env!("OUT_DIR"), "/trustsc_scenarios.rs"));
        }
    };
}

/// Brings the module generated by [`trustsc-build`](https://docs.rs/trustsc-build)'s `ModelPackage`
/// compiler into scope as `medui_model`, exposing `medui_model::model() -> trustsc::ModelPackage`
/// (ADR-017). Requires the calling crate's `build.rs` to have run
/// `trustsc_build::ModelPackage::new(..).compile()`. Swapping which committed
...
macro_rules! include_model {
    () => {
        pub mod medui_model {
            include!(concat!(env!("OUT_DIR"), "/trustsc_ml_model.rs"));
        }
    };
}
