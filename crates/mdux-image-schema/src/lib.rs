...
//! image baker (`tools/mdux-image-baker`) and every governed consumer. Mirrors the role
//! `mdux-text-schema` plays for fonts: authoring bakes deterministic evidence offline, the
