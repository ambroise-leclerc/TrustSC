...
- **§1 Scope** — applies to the organization/manufacturer, not to TrustSC as an SDK. [→](01-foundations-and-qms.md#1-scope)
...
- **§4.1 General requirements** — QMS process identification; outsourced-process control maps onto TrustSC's trust-zone architecture and SOUP register. [→](01-foundations-and-qms.md#41-general-requirements)
...
- **§4.2.2 Quality manual** — no TrustSC analogue; entirely manufacturer-authored. [→](01-foundations-and-qms.md#422-quality-manual)
...
- **§5.3 Quality policy** — entirely organizational; no TrustSC analogue. [→](02-management-and-resources.md#53-quality-policy)
...
- **§6.4 Work environment/contamination control** — no TrustSC analogue; physical-production scope only. [→](02-management-and-resources.md#64-work-environment-and-contamination-control)
...
- **§8.2.1 Feedback** — no TrustSC analogue; no post-market presence. [→](04-measurement-analysis-improvement.md#821-feedback)
...
- **§8.2.3 Reporting to regulatory authorities** — no TrustSC analogue whatsoever. [→](04-measurement-analysis-improvement.md#823-reporting-to-regulatory-authorities)
