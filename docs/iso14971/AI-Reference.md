...
- **§1 Scope** — applies to the manufacturer's device-level risk management, not to TrustSC as an SDK. [→](01-scope-and-general-requirements.md#1-scope)
...
- **§4.2 Management responsibilities** — entirely organizational; no TrustSC scaffolding. [→](01-scope-and-general-requirements.md#42-management-responsibilities)
...
- **§5.2 Intended use and reasonably foreseeable misuse** — a usability-engineering (IEC 62366-1) concern; no TrustSC scaffolding. [→](02-risk-analysis-and-evaluation.md#52-intended-use-and-reasonably-foreseeable-misuse)
...
- **§7.5 Risk-benefit analysis** — entirely clinical/regulatory judgment; no TrustSC scaffolding. [→](03-risk-control-and-residual-risk.md#75-risk-benefit-analysis)
...
- **§10.1 General** — no TrustSC post-market presence; entirely the manufacturer's own system. [→](04-production-and-post-production.md#101-general)
