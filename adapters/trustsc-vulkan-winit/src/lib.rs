...
use trustsc::input::{FrameEvents, WidgetEvent};
use trustsc::realtime::{ButtonBinding, FrameInputs, ScreenBindings, TextInputBinding};
use trustsc::verify_scenario::ScenarioScript;
use trustsc::{
...
pub struct RunOptions {
    ...
    /// screen offscreen per locale, run the `trustsc-ui-verify` check suite, and write evidence
