# Software Design Description (SDD) — MduX-rust
...
This SDD details the internal design of MduX-rust's governed crates, one level below the
...
### Unit: `mdux-text-authoring` / `mdux-text-runtime`
