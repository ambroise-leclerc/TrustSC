# ISO 13485:2016 quality management system — TrustSC's scope note
...
TrustSC is a software development kit, not a manufacturer, and does not operate a quality
...
## What TrustSC's engineering artifacts can feed into your QMS

> `ISO 13485:2016 §4.2 Documentation requirements`, `§7.3 Design and development`

- **Design and development traceability** — `trustsc_governance::ComplianceProgram::trace_rows()`/
...
- **Purchasing/supplier information for SOUP** — `docs/governance/soup-register.toml` records
  ...
  purchasing controls if a manufacturer treats TrustSC's SOUP as purchased/acquired product.

## What your QMS must still supply

- Management responsibility, quality policy, and management review (§5) — TrustSC has no concept
...
- Complaint handling, adverse-event/vigilance reporting, and CAPA (§8.2, §8.5) — TrustSC's
...
- Everything about the manufacturer's own device beyond what's built with TrustSC's UI/ML/governed
  types.
