...
use trustsc_image_baker::{CliInvocation, bake, placeholder_logo_ppm, verify};
...
fn usage() -> String {
    "usage: trustsc-image-baker <bake|verify> <recipe.toml> <package.json> <report.json>\n       trustsc-image-baker generate-placeholder <output.ppm>".to_string()
}
