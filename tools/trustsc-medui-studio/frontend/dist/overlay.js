...
export function boundsToStyle(bounds, surfaceWidth, surfaceHeight) {
    return {
...
function hasGoldenEvidence(node) {
 ...
 * re-querying the DOM. */
export function renderOverlay(container, nodes, surfaceWidth, surfaceHeight, options) {
    container.querySelectorAll(".node-overlay").forEach((el) => el.remove());
